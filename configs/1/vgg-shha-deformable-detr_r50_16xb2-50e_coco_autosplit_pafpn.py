...
work_dir = './work_dirs/vgg-shha-deformable-detr_r50_16xb2-50e_coco_split_pafpn'
...
max_epochs = 1000
train_cfg = dict(type='EpochBasedTrainLoop', max_epochs=max_epochs, val_begin=700, val_interval=1)

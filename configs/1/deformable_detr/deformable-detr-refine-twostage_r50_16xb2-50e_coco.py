...
train_dataloader = dict(
    ...
    dataset=dict(
        type='CocoDataset',
        data_root='data/coco/',
        ann_file='annotations/instances_train2017_minicoco_20.json',
...
val_dataloader = dict(
    ...
    dataset=dict(
        type='CocoDataset',
        data_root='data/coco/',
        ann_file='annotations/instances_val2017_minicoco_20.json',
...
val_evaluator = dict(
    type='CocoMetric',
    ann_file='data/coco/annotations/instances_val2017_minicoco_20.json',
    metric='bbox',
    format_only=False,
    backend_args=None)
test_evaluator = dict(

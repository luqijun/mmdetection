...
work_dir = './work_dirs/shha-deformable-detr_r50_16xb2-50e_coco_encoder1'
...
classes = 'person'
model = dict(
    type='Crowd_DeformableDETR_Encoder',
    num_queries=300,
    num_feature_levels=4,
    query_feature_level=1,
...
max_epochs = 500
train_cfg = dict(type='EpochBasedTrainLoop', max_epochs=500, val_begin=20, val_interval=1)

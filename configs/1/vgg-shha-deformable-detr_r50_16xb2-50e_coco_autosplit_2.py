...
work_dir = './work_dirs/vgg-shha-deformable-detr_r50_16xb2-50e_coco_split_2'
...
default_hooks = dict(
    ...
    logger=dict(type='LoggerHook', interval=15),
...
max_epochs = 701
train_cfg = dict(type='EpochBasedTrainLoop', max_epochs=max_epochs, val_begin=60, val_interval=1)
